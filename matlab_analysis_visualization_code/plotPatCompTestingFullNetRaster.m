function [] = plotPatCompTestingFullNetRaster(assemB1,assemB2,assemB3, ...
...
% stimAssemIdx = find((SRPyrRaster(2,:) >= 0 & SRPyrRaster(2,:) < 150) | ...
% (SRPyrRaster(2,:) >= 300 & SRPyrRaster(2,:) < 450) | ...
% (SRPyrRaster(2,:) >= 600 & SRPyrRaster(2,:) < 750));
% nonStimAssemIdx = find((SRPyrRaster(2,:) >= 150 & SRPyrRaster(2,:) < 300) | ...
% (SRPyrRaster(2,:) >= 450 & SRPyrRaster(2,:) < 600) | ...
% (SRPyrRaster(2,:) >= 750 & SRPyrRaster(2,:) < 900));
